...
%prep
%setup -q -n oslo.privsep-2.4.0
cd %{_builddir}/oslo.privsep-2.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600109571
...
cp %{_builddir}/oslo.privsep-2.4.0/LICENSE %{buildroot}/usr/share/package-licenses/oslo.privsep/294b43b2cec9919063be1a3b49e8722648424779
