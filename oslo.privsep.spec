...
Source0  : https://files.pythonhosted.org/packages/11/7a/e821e12078f195e8a2c21711195bbe1fe9023057e3cb663e15cacf98c839/oslo.privsep-2.3.0.tar.gz
...
%prep
%setup -q -n oslo.privsep-2.3.0
cd %{_builddir}/oslo.privsep-2.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596469776
...
cp %{_builddir}/oslo.privsep-2.3.0/LICENSE %{buildroot}/usr/share/package-licenses/oslo.privsep/294b43b2cec9919063be1a3b49e8722648424779
